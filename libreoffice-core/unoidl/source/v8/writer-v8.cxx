...
void V8Writer::writeDeclarations() {
    ...
    out("inline void MaybeThrowErr(v8::Isolate* isolate, rtl_uString* err);\n");
    ...
    out(R"(
inline uno_Sequence* Sequence(v8::Isolate* isolate, v8::Local<v8::Value> val, typelib_TypeDescriptionReference *typeRef);
inline v8::Local<v8::Value> Sequence(v8::Isolate* isolate, uno_Sequence* val, typelib_TypeDescriptionReference *typeRef);
inline v8::Local<v8::Value> AnyStructValue(v8::Isolate* isolate, void* val, rtl_uString* typeName);
inline void AnyStructValue(v8::Isolate* isolate, v8::Local<v8::Value> val, void* out_val, unsigned int type_id);
inline v8::Local<v8::Value> AnyInterfaceValue(v8::Isolate* isolate, void* val, rtl_uString* typeName);
inline v8::Local<v8::Value> AnyInterfaceValue(v8::Isolate* isolate, void* val, std::string_view typeName);
inline v8::Local<v8::Value> AnyValue(v8::Isolate* isolate, void* val, typelib_TypeClass typeClass, rtl_uString* typeName);
inline void AnySimpleValue(v8::Isolate* isolate, v8::Local<v8::Value> val, void* out_val, typelib_TypeClass typeClass);
...
inline v8::Local<v8::Value> Bool(v8::Isolate* isolate, sal_Bool val) {
    return v8::Boolean::New(isolate, val == sal_True).As<v8::Value>();;
}

inline sal_Int8 Byte(v8::Isolate* isolate, v8::Local<v8::Value> val) {
    if (!val->IsInt32()) {
...
inline v8::Local<v8::Value> Byte(v8::Isolate* isolate, sal_Int8 val) {
    return v8::Integer::New(isolate, val).As<v8::Value>();
}

inline sal_Int16 Short(v8::Isolate* isolate, v8::Local<v8::Value> val) {
    if (!val->IsInt32()) {
        ThrowTypeError(isolate, "unexpected type, expected integer");
        return 0;
    }
...
inline v8::Local<v8::Value> Short(v8::Isolate* isolate, sal_Int16 val) {
    return v8::Integer::New(isolate, val).As<v8::Value>();
}

inline sal_Int32 Long(v8::Isolate* isolate, v8::Local<v8::Value> val) {
    if (!val->IsInt32()) {
        ThrowTypeError(isolate, "unexpected type, expected integer");
        return 0;
    }
...
inline v8::Local<v8::Value> Long(v8::Isolate* isolate, sal_Int32 val) {
    return v8::Integer::New(isolate, val).As<v8::Value>();
}

inline sal_uInt32 UShort(v8::Isolate* isolate, v8::Local<v8::Value> val) {
    if (!val->IsInt32()) {
...
inline v8::Local<v8::Value> UShort(v8::Isolate* isolate, sal_uInt32 val) {
    return v8::Integer::NewFromUnsigned(isolate, val).As<v8::Value>();
}

inline sal_uInt32 ULong(v8::Isolate* isolate, v8::Local<v8::Value> val) {
    if (!val->IsInt32()) {
        ThrowTypeError(isolate, "unexpected type, expected unsigned integer");
        return 0;
    }
...
inline v8::Local<v8::Value> ULong(v8::Isolate* isolate, sal_uInt32 val) {
    return v8::Integer::NewFromUnsigned(isolate, val).As<v8::Value>();
}

inline float Float(v8::Isolate* isolate, v8::Local<v8::Value> val) {
    if (!val->IsNumber()) {
...
inline v8::Local<v8::Value> Float(v8::Isolate* isolate, float val) {
    return v8::Number::New(isolate, val).As<v8::Value>();
}

inline double Double(v8::Isolate* isolate, v8::Local<v8::Value> val) {
    if (!val->IsNumber()) {
...
inline v8::Local<v8::Value> Double(v8::Isolate* isolate, double val) {
    return v8::Number::New(isolate, val).As<v8::Value>();
}

inline sal_Int64 Hyper(v8::Isolate* isolate, v8::Local<v8::Value> val) {
    if (!val->IsBigInt()) {
...
inline v8::Local<v8::Value> Hyper(v8::Isolate* isolate, sal_Int64 val) {
    return v8::BigInt::New(isolate, val).As<v8::Value>();
}

inline sal_uInt64 UHyper(v8::Isolate* isolate, v8::Local<v8::Value> val) {
    if (!val->IsBigInt()) {
        ThrowTypeError(isolate, "unexpected type, expected BigInt");
        return 0;
    }
...
inline v8::Local<v8::Value> UHyper(v8::Isolate* isolate, sal_uInt64 val) {
...
namespace {
inline bool IsValueClassType(v8::Isolate* isolate, v8::Local<v8::Value> val, typelib_TypeClass typeClass) {
    switch (typeClass) {
...
inline uno_Sequence* Sequence(v8::Isolate* isolate, v8::Local<v8::Value> val, typelib_TypeDescriptionReference* elTypeRef) {
    auto& unov8_ = electron::office::OfficeClient::GetUnoV8();
    if (!val->IsArray()) {
